...
import { Send, Loader2, Play, Eye, Brain, Hand, ShieldCheck, Terminal, AlertTriangle, Clapperboard, MessageSquare } from 'lucide-react';
        ...
        <>
            ...
            <div className="p-3 border-t border-neutral-800 bg-neutral-900">
                <div className="relative flex items-center bg-neutral-950 border border-neutral-800 rounded-2xl px-2 py-1 focus-within:border-purple-500/50 transition-colors">
                    ...
                    />
                    <button onClick={handleDirectorSendMessage} disabled={isProcessing || !directorQuery.trim()} className="p-2 hover:bg-neutral-800 rounded-xl text-purple-400 transition-colors shrink-0 disabled:opacity-30 disabled:cursor-not-allowed">
                    <Send size={14} />
                    </button>
                </div>
            </div>
